describe ApplicationController do
  describe "POST /add_article" do
    ...
    context "with existed title" do
      before { CreateArticleWithTerms.call(title: title, body: body) }
  ...
  describe "GET /search_any_term" do
    let!(:article1) { CreateArticleWithTerms.call(title: "article1", body: "hello world") }
    let!(:article2) { CreateArticleWithTerms.call(title: "article2", body: "hello kitty") }
  ...
  describe "GET /search_ranked" do
    let!(:article1) { CreateArticleWithTerms.call(title: "article1", body: "hello hello kitty") }
    let!(:article2) { CreateArticleWithTerms.call(title: "article2", body: "hello kitty kitty kitty") }
